...
// applyClaudeOpenAIPriorityConfig forces OpenAI priority service_tier for Claude-originated
// requests routed through OpenAI-compatible upstreams when the translated payload is otherwise
// silent (or only carries "auto"). Operational toggle for Claude Code -> CLIProxy -> GPT-5.x.
